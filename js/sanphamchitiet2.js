var ListItems = {
 ...
 document.querySelector('#Ten').innerText = ListItems[localStorage.ID].Ten;
 document.querySelector('#Gia').innerText = ListItems[localStorage.ID].Giaban;
 document.querySelector('#Nguyenlieu').innerText = ListItems[localStorage.ID].Nguyenlieu;
 document.querySelector('#Kichthuoc').innerText = ListItems[localStorage.ID].Kichthuoc;
 document.querySelector('#Hinhanh').src = ListItems[localStorage.ID].Hinhanh;

btnAddCart = document.querySelector('.btn-addcart');
...
btnAddCart.addEventListener('click', () => {
    if (cartList.includes(localStorage.ID)){}
    else {
        cartList.push(localStorage.ID);
    }
